...
package alpha // import "google.golang.org/grpc/examples/route_guide/routeguide"
...
func (*Point) Descriptor() ([]byte, []int) {
	return fileDescriptor_route_guide_bc910c2a3a42bdd6, []int{0}
}
...
func (*Rectangle) Descriptor() ([]byte, []int) {
	return fileDescriptor_route_guide_bc910c2a3a42bdd6, []int{1}
}
...
func (*Feature) Descriptor() ([]byte, []int) {
	return fileDescriptor_route_guide_bc910c2a3a42bdd6, []int{2}
}
...
func (*RouteNote) Descriptor() ([]byte, []int) {
	return fileDescriptor_route_guide_bc910c2a3a42bdd6, []int{3}
}
...
func (*RouteSummary) Descriptor() ([]byte, []int) {
	return fileDescriptor_route_guide_bc910c2a3a42bdd6, []int{4}
}
...
func init() { proto.RegisterFile("route_guide.proto", fileDescriptor_route_guide_bc910c2a3a42bdd6) }

var fileDescriptor_route_guide_bc910c2a3a42bdd6 = []byte{
	// 432 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0x84, 0x53, 0x4d, 0x6f, 0xd3, 0x40,
	0x10, 0xad, 0x43, 0x4b, 0xe3, 0x49, 0x10, 0xea, 0x20, 0x24, 0x2b, 0x20, 0x41, 0xcd, 0xa5, 0x17,
	...
	,
}
