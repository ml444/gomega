...
type OmegaServiceClient interface {
	...
	AddTopic(ctx context.Context, in *Topic, opts ...grpc.CallOption) (*Response, error)
...
func (c *omegaServiceClient) AddTopic(ctx context.Context, in *Topic, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/omega.OmegaService/AddTopic", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OmegaServiceServer interface {
	...
	AddTopic(context.Context, *Topic) (*Response, error)
...
func (UnimplementedOmegaServiceServer) AddTopic(context.Context, *Topic) (*Response, error) {
...
func _OmegaService_AddTopic_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Topic)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OmegaServiceServer).AddTopic(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/omega.OmegaService/AddTopic",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OmegaServiceServer).AddTopic(ctx, req.(*Topic))
	}
	return interceptor(ctx, in, info, handler)
}
...
var OmegaService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AddTopic",
			Handler:    _OmegaService_AddTopic_Handler,
		},
		{
